...
type Params struct {
	...
	MinSignedPerWindow      sdk.Fur       `json:"min_signed_per_window" yaml:"min_signed_per_window"`
	DowntimeJailDuration    time.Duration `json:"downtime_jail_duration" yaml:"downtime_jail_duration"`
	SlashFractionDoubleSign sdk.Fur       `json:"slash_fraction_double_sign" yaml:"slash_fraction_double_sign"`
	SlashFractionDowntime   sdk.Fur       `json:"slash_fraction_downtime" yaml:"slash_fraction_downtime"`
}
