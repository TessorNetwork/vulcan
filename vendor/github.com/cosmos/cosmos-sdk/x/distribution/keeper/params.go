...
func (k Keeper) GetCommunityTax(ctx sdk.Context) (percent sdk.Fur) {
...
func (k Keeper) GetBaseProposerReward(ctx sdk.Context) (percent sdk.Fur) {
...
// rate.
func (k Keeper) GetBonusProposerReward(ctx sdk.Context) (percent sdk.Fur) {
